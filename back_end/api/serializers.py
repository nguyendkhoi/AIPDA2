...
class UserSerializers(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = ['id', 'email', 'prenom', 'nom', 'role', 'telephone', 'pays_residence', 'profession', 'organisation', 'lien_portfolio', 'date_de_creation', 'password', 'password2']
        extra_kwargs = {
...
class ProgrammeSerializers(serializers.ModelSerializer):
    ...
    class Meta:
        model = Programme
        fields = ['id', 'nom', 'animateur', 'edition_du_Tour', 'nb_participants_max', 'participants', 'temps_de_participation', 'date_de_debut', 'description', 'date_de_creation']
        extra_kwargs = {
            'id': {'read_only': True},
    ...
    def validate_nom(self, value):
        ...
        if (value not in ['webinaire', 'atelier', 'talk']):
    ...
    def create(self, validated_data):
        ...
        for participant_data in participants_data:
            programme.participants.add(participant_data)
