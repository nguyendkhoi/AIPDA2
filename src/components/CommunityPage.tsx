...
const CommunityPage = ({onOpenSignup}:CommunityPageProps) => {
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="text-center mb-16">
                        ...
                        <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
                            Rejoignez un réseau dynamique de professionnels du design et participez à
                    ...
                    <div className="bg-indigo-600 rounded-xl shadow-lg p-8 text-center text-white mb-16">
                        ...
                        <p className="text-indigo-100 mb-8 max-w-2xl mx-auto">
                            Que vous soyez participant ou animateur, votre expertise enrichira notre
                            communauté. Rejoignez-nous dès aujourd'hui !
                        </p>
                        <button
                            onClick={onOpenSignup}
