...
const LandingPage = ({onOpenSignup }: LandingPageProps) => {
    ...
    return (
        <div className="space-y-24">
            ...
            <section className="pt-32 pb-16 px-4">
                <div className="max-w-7xl mx-auto text-center">
                    ...
                    <p className="text-xl text-gray-600 mb-12 max-w-2xl mx-auto">
                        Rejoignez une communauté dynamique de designers et participez à des sessions
                        interactives pour enrichir votre expertise.
                    </p>
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        ...
                        <div className="bg-white p-6 rounded-xl shadow-md">
                            ...
                            <p className="text-gray-600">
                                Des sessions pratiques pour développer vos compétences techniques.
                            </p>
                        </div>
                        <div className="bg-white p-6 rounded-xl shadow-md">
                            <div className="w-12 h-12 bg-indigo-100 rounded-lg flex items-center justify-center mb-4">
            ...
            <section id="communaute" className="py-16 px-4">
                <div className="max-w-7xl mx-auto text-center">
                    <h2 className="text-3xl font-bold mb-12">Rejoignez notre communauté</h2>
                    <div className="flex items-center justify-center mb-8">
                        <Users className="w-16 h-16 text-indigo-600" />
                    </div>
                    <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
                        Faites partie d'un réseau de professionnels passionnés et partagez vos expériences.
                    </p>
                    <button
